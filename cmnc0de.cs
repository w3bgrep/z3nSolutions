...
{
         public static List<string> ParseWebGl2(this Instance instance, string vendor, int qnt, IZennoPosterProjectModel project)
        {
            ...
            while (result.Count < qnt)
            {
                ...
                project.L0g($"vendorNotMatch rrgenerating...");
    ...
    public void MapAndImport(schema tableSchem, int startFrom = 1)
    {
        ...
        switch (tableSchem)
        {
            ...
            case schema.private_profile:
                ...
                {
                    var webGl = _instance.ParseWebGl2(vendor, _range, _project);
