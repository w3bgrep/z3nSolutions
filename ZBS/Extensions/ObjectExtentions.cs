...
namespace z3n.MethodExtensions
{
    ...
    {
        public static double randomPercent(this double input, double percent, double maxPercent)
        {
        ...
        public static double randomPercent(this decimal input, double percent, double maxPercent)
        {
            if (percent < 0 || maxPercent < 0 || percent > 100 || maxPercent > 100)
                throw new ArgumentException("Percent and MaxPercent must be between 0 and 100");
