...
namespace w3tools //by @w3bgrep
{
    ...
    public  static class TestStatic
    {
        ...
        public static void SetProxy2(this Instance instance, string proxy, IZennoPosterProjectModel project)
        {
        ...
        public static List<string> ParseWebGl2(this Instance instance, string vendor, int qnt, IZennoPosterProjectModel project, bool before78)
        {
            ...
            while (result.Count < qnt)
            {
                ...
                if (instance.BrowserType == BrowserType.Chromium)
                    try { instance.Launch(BrowserType.WithoutBrowser, false); }
                    catch (Exception ex) { project.L0g($"Error launching: {ex.Message}"); }
